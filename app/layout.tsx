    ...
    <html>
      <body className={roboto_slab.className} >
        <Image src={BgImage} alt="Horse Nebula" fill
          ...
          style={{ objectFit: 'cover', objectPosition: 'center',background: 'rgb(222,0,255)',background: 'radial-gradient(circle, rgba(222,0,255,0.9724483543417367) 6%, rgba(46,1,1,1) 59%)', zIndex:-1 }}
          priority
          quality={100}
        />
        {children}
